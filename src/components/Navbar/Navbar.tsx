  ...
  "VİTAMİN": [
    {
      ...
      links: [
        ...
        { label: "Gamer Multivitamin", href: "/vitamin/ozel-formul/gamer-multivitamin" },
        { label: "GDA", href: "/vitamin/ozel-formul/gda" },
        { label: "C-Blocker", href: "/vitamin/ozel-formul/c-blocker" },
        { label: "Sleep Formula", href: "/vitamin/ozel-formul/sleep-formula" },
      ],
    },
    {
      title: "POPÜLER TAKVİYELER",
      links: [
        { label: "ZMA", href: "/vitamin/populer-takviyeler/zma" },
        { label: "Thermo Burner", href: "/vitamin/populer-takviyeler/thermo-burner" },
        { label: "Omega 3", href: "/vitamin/populer-takviyeler/omega-3" },
        { label: "Multivitamin", href: "/vitamin/populer-takviyeler/multivitamin" },
        { label: "C Vitamini Efervesan", href: "/vitamin/populer-takviyeler/c-vitamini-efervesan" },
        { label: "Kafein", href: "/vitamin/populer-takviyeler/kafein" },
        { label: "Kolajen + Hyaluronik Asit", href: "/vitamin/populer-takviyeler/kolajen-hyaluronik-asit" },
        { label: "Glikozamin Kondroitin", href: "/vitamin/populer-takviyeler/glikozamin-kondroitin" },
        { label: "MSM", href: "/vitamin/populer-takviyeler/msm" },
      ],
    },
    {
      title: "VİTAMİNLER",
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Gingko Biloba", href: "/vitamin/bitkisel/gingko-biloba" },
        { label: "Beta Glukan", href: "/vitamin/bitkisel/beta-glukan" },
      ],
    },
    {
      title: "DİĞER",
      links: [
        { label: "CLA", href: "/vitamin/diger/cla" },
        { label: "Bromelain", href: "/vitamin/diger/bromelain" },
        { label: "Koenzim Q 10", href: "/vitamin/diger/koenzim-q10" },
        { label: "Alpha GPC", href: "/vitamin/diger/alpha-gpc" },
        { label: "Glutatyon", href: "/vitamin/diger/glutatyon" },
        { label: "NMN", href: "/vitamin/diger/nmn" },
        { label: "Hyaluronik Asit", href: "/vitamin/diger/hyaluronik-asit" },
        { label: "Laktaz", href: "/vitamin/diger/laktaz" },
      ],
    },
  ],
  "AKSESUAR": [
