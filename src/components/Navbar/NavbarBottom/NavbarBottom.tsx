    ...
    <>
      <div className="w-[1200px] h-full flex items-center justify-center">
          ...
          <div className="flex items-center gap-2 w-1/3 justify-center">
            {/* İkon */}
            <img src="../../../public/Header/image_180.webp.png" alt="Kargo" className="w-4 h-4" />
            {/* Metin */}
          ...
          {/* 2. Bilgi */}
          <div className="flex items-center gap-2 w-1/3 justify-center">
            <img src="../../../public/Header/image_180-1.webp.png" alt="Ücretsiz Kargo" className="w-4 h-4" />
          ...
          {/* 3. Bilgi */}
          <div className="flex items-center gap-2 w-1/3 justify-center">
            <img src="../../../public/Header/image_180-2.webp.png" alt="Güvenli Alışveriş" className="w-4 h-4" />
