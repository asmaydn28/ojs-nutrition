...
import { getMyPermissionsController } from '../controllers/role.controller';
...
// GET /api/auth/permissions - Giriş yapan kullanıcının yetkileri
router.get('/permissions', authMiddleware, getMyPermissionsController);
